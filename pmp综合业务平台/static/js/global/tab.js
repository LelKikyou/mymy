...
top.Sdcm.frameTab = {
    ...
    open: function (module, notAllowClosed) {
        ...
        if (iframeIdList[module.F_ModuleId] == undefined || iframeIdList[module.F_ModuleId] == null) {
            ...
            var $tabItem = $('<li class="sdcm-frame-tabItem active" id="sdcm_tab_' + module.F_ModuleId + '" parent-id="' + parentId + '"  ><span><i class="' + module.F_Icon + ' iconfont"></i>&nbsp;' + module.F_FullName + '</span></li>');
            if (!notAllowClosed) {
    ...
    close: function (moduleId) {
        ...
        if (moduleId == Sdcm.frameTab.iframeId && $prev.length > 0) {
            ...
            $(".sdcm-frame-tabs-wrap").mCustomScrollbar("update");
            $('.sdcm-frame-tabs').css('width', 'calc(100% - 530px)');
