var sdcm = function ($, Sdcm) {
    ...
    var page = {
        ...
        initLoad: function () {
            var headData = [
                    {name: "", width: "3%"}, {name: "序号", width: "7%"}, {name: "用户名", width: "12%"},
                    {name: "姓名", width: "12%"},{name: "状态", width: "10%"}, {name: "主单位", width: "12%"},
                    {name: "主职务", width: "12%"}, {name: "意见级别", width: "12%"},  {name: "操作", width: "20%"}
                ];
