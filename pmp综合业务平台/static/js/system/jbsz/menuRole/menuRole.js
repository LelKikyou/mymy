    ...
    var page = {
        ...
        event: function () {
            ...
            $(".sdcm-add").click(function () {
                ...
                Sdcm.layerForm({
                    ...
                    width: 800,
                    height: 600,
                    url: "/system/menuRole/menuRoleForm",
        ...
        initLoad: function () {
            var headData = [{name: "", width: "3%"}, {
                name: "序号",
                width: "5%"
            }, {name: "角色姓名", width: "10%"}, {name: "状态", width: "10%"}, {name: "角色备注", width: "27%"}, {
                name: "角色等级",
                width: "10%"
            }, {name: "创建时间", width: "15%"}, {name: "操作", width: "20%"}];
